...
public class CompanyController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<PagedResult<CompanyResponse>>> getAllCompanies(
            @PageableDefault(
                    page = 0,
                    size = 10,
                    sort = "createdAt",
        ...
        return ResponseEntity.ok(ApiResponse.success("Lấy danh sách công ty thành công", PagedResult.from(companies)));
    }
